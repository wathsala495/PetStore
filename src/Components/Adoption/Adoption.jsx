...
const Adoption = () => {
  return (
    ...
    {/* <div className='absolute top-[3740.98px] left-[1329.98px] w-[538.53px] h-[358.70px] rotate-[125.93deg]'> */}
    <div className='absolute top-[3500.98px] left-[1202.48px] w-[538.53px] h-[358.70px] rotate-[125.93deg]'>
       <img src={pethand} alt="" />
    </div>
    </>
